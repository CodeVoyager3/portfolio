            ...
            <BlurFade delay={0.1}>
                <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
                    ...
                    <div className="flex-1">
                        {/* Name */}
                        <h3 className="text-2xl sm:text-3xl font-(family-name:--font-instrument-serif) text-black dark:text-white mb-4">
                            Amritesh Kumar Rai
                        </h3>

                        {/* Bio */}
                        <p className="text-neutral-600 mb-10 mt-10 dark:text-neutral-400 text-sm sm:text-base leading-relaxed">
