        ...
        <section className="w-full mt-0 mb-16">
            ...
            <BlurFade delay={0.05} inView={false}>
                <div className="relative w-full h-[200px] sm:h-[270px] mb-6 rounded-2xl overflow-hidden">
                    ...
                    <div className="absolute inset-0 z-20 flex items-center justify-center px-6">
                        <p
                            className="text-white text-lg sm:text-2xl md:text-3xl italic font-(family-name:--font-instrument-serif) text-center font-medium"
            ...
            <BlurFade delay={0.35} inView={false}>
                <div className="flex mt-10 items-center gap-3">
                    <RainbowButton asChild className="h-11 px-8 rounded-full font-medium">
                        <a
                            href="/resume"
                    ...
                    <ShimmerButton
                        ...
                        className="h-11 px-8 rounded-full bg-white dark:bg-[#0b0f1a] text-black dark:text-white font-medium!"
                        background={mounted && resolvedTheme === "dark" ? "#0b0f1a" : "#fff"}
                        shimmerColor={mounted && resolvedTheme === "dark" ? "#ffffff" : "#000000"}
                        shimmerSize="0.1em"
                        borderRadius="9999px"
                    >
