            ...
            <section className="hero-section w-full">
                ...
                <BlurFade delay={0.5} inView={false}>
                    <div className="hero-buttons">
                        ...
                        <button
                            ...
                            className="hero-btn hero-btn-secondary cursor-pointer"
                        >
                            <span className="btn-icon">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <BlurFade delay={0.6} inView={false}>
                    <div className="hero-socials">
                        ...
                        <Tooltip.Root>
                            <Tooltip.Trigger asChild>
                                <a href="https://www.youtube.com/@amriteshkumarrai9405" className="social-icon" aria-label="YouTube">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
